  ...
  return (
    <nav
      className={`${
        ...
        scrolled
          ? "bg-black/95 backdrop-blur-md shadow-lg border-b border-white border-opacity-30"
          : "bg-black/90 backdrop-blur-sm border-b border-white border-opacity-20"
      }`}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10 items-center">
          ...
          <li>
            <a
              ...
              className="relative inline-flex items-center gap-2 px-5 py-2.5 bg-black hover:bg-white text-white hover:text-black font-mono font-bold text-[15px] rounded-lg border-2 border-white hover:border-black transition-all duration-300 hover:scale-105 shadow-xl backdrop-blur-sm group/resume"
            >
              <svg
        ...
        {toggle && (
          <div className="sm:hidden p-6 fixed top-20 right-0 mx-4 my-2 min-w-[220px] z-40 rounded-lg shadow-xl bg-black/95 border border-white border-opacity-30 backdrop-blur-md animate-slideIn">
            <ul className="list-none flex justify-end items-start flex-col gap-4">
              ...
              <li className="w-full pt-2 border-t border-white border-opacity-30">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setToggle(false)}
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-black hover:bg-white text-white hover:text-black font-mono font-bold text-[15px] rounded-lg border-2 border-white hover:border-black transition-all duration-300 shadow-xl shadow-white/30 backdrop-blur-sm hover:scale-105"
                >
                  <svg
